...
public class FunctionMoneda {
    ...
    public void ConvertirMonedas(double Minput) {
    	String opcion = (JOptionPane.showInputDialog(null, 
    			...
    			{"De Pesos Colombianos a Dólar", "De Pesos Colombianos a Euro", "De Pesos Colombianos a Libras","De Pesos Colombianos a Yenes","De Pesos Colombianos a Won Coreano","De Dólar a Pesos Colombianos", "De Euro a Pesos Colombianos", "De Libras a Pesos Colombianos","De Yenes a Pesos Colombianos","De Won Coreano a Pesos Colombianos"}, 
    			"Seleccion")).toString();
        switch(opcion) {
        ...
        case "De Pesos Colombianos a Libras":
        	...
        	break;
        case "De Pesos Colombianos a Yenes":
